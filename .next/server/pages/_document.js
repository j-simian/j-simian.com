	...
	exports.modules = {
					...
					updateHead: (head) => {
						const promise = (updatePromise = Promise.resolve().then(
							() => {
								...
								const titleComponent = tags.title
									? tags.title[0]
									: null;
								let title = "";
								if (titleComponent) {
		...
		/***/ 573: /***/ (module, exports, __webpack_require__) => {
			...
			function Script(props) {
				...
				const { updateScripts, scripts, getIsSsr } = (0,
					...
					const userDefinedConfig = children.find((child) => {
						...
						return (
							...
							(child === null || child === void 0
								...
								? void 0
								: (ref1 = ref.dangerouslySetInnerHTML) ===
										null || ref1 === void 0
								? void 0
								: ref1.__html.length) &&
          ...
          `,
			...
			function getPreNextScripts(context, props) {
				const { scriptLoader, disableOptimizedLoading, crossOrigin } =
					context;
				const webWorkerScripts = getPreNextWorkerScripts(
					context,
					props
				);
			...
			Document.__next_internal_document =
			...
			class Head extends _react.Component {
				getCssLinks(files) {
					...
					if (true && optimizeFonts) {
						cssLinkElements =
							this.makeStylesheetInert(cssLinkElements);
					}
