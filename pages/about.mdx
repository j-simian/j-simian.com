...
I am a Production Engineer at Jane Street.

### Find me online

 - [Medium](https://medium.com/@jxssica.simian)
 - [Twitter](https://twitter.com/jsimian_dev)
 - [Github](https://github.com/j-simian)

### Experience

<p style="display: flex; flex-direction: row; justify-content: space-between;">
  <span style="margin: 0;">
    <b>Production Engineer</b> • <i>Jane Street</i>
  </span>
  <span style="margin: 0; text-align: right;">Jul 2024-Present</span>
</p>

 - Designed and deployed systems to perform workload management, automatically
 pairing tasks with appropriate hosts.
 - Improved config generation systems to minimise build times and increase
 developer productivity. 
 - Automated several toil-like support processes, saving developer time and
 reducing the chance of human error. 

<p style="display: flex; flex-direction: row; justify-content: space-between;">
  <span style="margin: 0;">
    <b>Production Engineering Internship</b> • <i>Jane Street</i>
  </span>
...
<p style="display: flex; flex-direction: row; justify-content: space-between;">
  <span style="margin: 0;">
    <b>Frontend Engineering Internship</b> • <i>Acre Platforms Ltd.</i>
  </span>
...
<p style="display: flex; flex-direction: row; justify-content: space-between;">
  ...
  <span style="margin: 0; text-align: right;">Oct 2021 - Jul 2024</span>
</p>
